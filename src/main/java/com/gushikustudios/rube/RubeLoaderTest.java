...
public class RubeLoaderTest implements ApplicationListener, InputProcessor, ContactListener
{
   ...
   private static final float MAX_FORCE_H = -5.0f;
   private static final float MAX_FORCE_V = -2.0f;
...
//      testSceneSettings();
   ...
   private void updatePhysics(float delta)
   {
       ...
       {
           float accelX = Gdx.input.getAccelerometerX() * MAX_FORCE_H;
           float accelY = Gdx.input.getAccelerometerY() * MAX_FORCE_V;
           
           mGravity.set(accelX, accelY);
           
           mWorld.setGravity(mGravity);
           
//           final Array<Body> bodys = mScene.getNamed(Body.class, "drivewheel");
//           
//           if ( bodys != null && bodys.size > 0) {
//               
//               final Body b =  bodys.get(0);
//               
//               b.applyForceToCenter(accelX, MAX_FORCE, true);
//           }
       }
